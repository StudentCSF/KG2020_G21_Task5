...
import course2.kg.valeev.timers.AbstractWorldTimer;
import javax.swing.JPanel;
import javax.swing.Timer;
import course2.kg.valeev.math.Rectangle;
import course2.kg.valeev.model.Field;
import course2.kg.valeev.model.Ball;
import course2.kg.valeev.model.Billiard;
import course2.kg.valeev.timers.UpdateWorldTimer;
...
public class DrawPanel extends JPanel implements ActionListener,
    ...
    public DrawPanel() {
        ...
        Field f = new Field(
            ...
            0.1, 9.8);
        w = new Billiard(8, f);
        sc = new ScreenConverter(f.getRectangle(), 1200, 600);
